...
`timescale 1 ps / 1 ps
module xyz_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                           //                                         clk_0_clk.clk
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset,          //          nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset, // opencores_i2c_0_clock_reset_reset_bridge_in_reset.reset
	...
	wire  [95:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_3_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_3_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_3_s1_agent:cp_channel
	...
	wire  [95:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> pio_1_s1_agent:cp_data
	...
	wire  [95:0] pio_3_s1_agent_rp_data;                                                             // pio_3_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_010:sink_data
	...
	wire         cmd_demux_001_src4_valid;                                                           // cmd_demux_001:src4_valid -> cmd_mux_010:sink1_valid
	wire  [95:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_010:sink1_data
	wire         cmd_demux_001_src4_ready;                                                           // cmd_mux_010:sink1_ready -> cmd_demux_001:src4_ready
	wire  [10:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_010:sink1_channel
	wire         cmd_demux_001_src4_startofpacket;                                                   // cmd_demux_001:src4_startofpacket -> cmd_mux_010:sink1_startofpacket
	wire         cmd_demux_001_src4_endofpacket;                                                     // cmd_demux_001:src4_endofpacket -> cmd_mux_010:sink1_endofpacket
	...
	wire         rsp_demux_010_src1_valid;                                                           // rsp_demux_010:src1_valid -> rsp_mux_001:sink4_valid
	wire  [95:0] rsp_demux_010_src1_data;                                                            // rsp_demux_010:src1_data -> rsp_mux_001:sink4_data
	wire         rsp_demux_010_src1_ready;                                                           // rsp_mux_001:sink4_ready -> rsp_demux_010:src1_ready
	wire  [10:0] rsp_demux_010_src1_channel;                                                         // rsp_demux_010:src1_channel -> rsp_mux_001:sink4_channel
	wire         rsp_demux_010_src1_startofpacket;                                                   // rsp_demux_010:src1_startofpacket -> rsp_mux_001:sink4_startofpacket
	wire         rsp_demux_010_src1_endofpacket;                                                     // rsp_demux_010:src1_endofpacket -> rsp_mux_001:sink4_endofpacket
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                           //                      clk.clk
		.reset                  (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                                   //             clk.clk
		.reset                   (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
	...
	xyz_mm_interconnect_0_router router (
	...
	xyz_mm_interconnect_0_router_001 router_001 (
	...
	xyz_mm_interconnect_0_router_002 router_002 (
	...
	xyz_mm_interconnect_0_router_002 router_003 (
	...
	xyz_mm_interconnect_0_router_002 router_004 (
	...
	xyz_mm_interconnect_0_router_002 router_005 (
	...
	xyz_mm_interconnect_0_router_006 router_006 (
	...
	xyz_mm_interconnect_0_router_006 router_007 (
	...
	xyz_mm_interconnect_0_router_006 router_008 (
	...
	xyz_mm_interconnect_0_router_006 router_009 (
	...
	xyz_mm_interconnect_0_router_006 router_010 (
	...
	xyz_mm_interconnect_0_router_006 router_011 (
	...
	xyz_mm_interconnect_0_router_002 router_012 (
	...
	xyz_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux_004 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux_004 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (clk_0_clk_clk),                                  //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	xyz_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	xyz_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                             // in_clk_0.clk
		.in_rst_0_reset (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
